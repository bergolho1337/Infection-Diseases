...
def plot_results(t, s1, i1, r1, s2, i2, r2):
    ...
    plt.plot(t, s1, label="S_1", linewidth=3.0)
    plt.plot(t, s2, label="S_2", linewidth=3.0)
    plt.legend(loc=0,fontsize=14)
    #plt.show()
    plt.savefig("figs/s-comparison.pdf")

    plt.clf()
    plt.title("Infectious",fontsize=14)
    plt.xlabel("Time",fontsize=15)
    plt.ylabel("%",fontsize=15)
    plt.plot(t, i1, label="I_1", linewidth=3.0)
    plt.plot(t, i2, label="I_2", linewidth=3.0)
    plt.legend(loc=0,fontsize=14)
    #plt.show()
    plt.savefig("figs/i-comparison.pdf")

    plt.clf()
    plt.title("Recovered",fontsize=14)
    plt.xlabel("Time",fontsize=15)
    plt.ylabel("%",fontsize=15)
    plt.plot(t, r1, label="R_1", linewidth=3.0)
    plt.plot(t, r2, label="R_2", linewidth=3.0)
    plt.legend(loc=0,fontsize=14)
    #plt.show()
    plt.savefig("figs/r-comparison.pdf")
